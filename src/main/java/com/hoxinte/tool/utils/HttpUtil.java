...
import com.hoxinte.tool.clients.entity.HttpDeleteWithBody;
...
public class HttpUtil {
    ...
    public static String sendGetSetHeader(String url, Map<String, String> headerMap) {
        HttpGet httpGet = createGet(url, headerMap);
    ...
    public static String sendGet(String url, Map<String, Object> paramMap, Map<String, String> customHeaderMap) {
        ...
        HttpGet httpGet = createGet(getUrl, customHeaderMap);
        return execute(httpGet);
    }
    ...
    public static String sendPost(String url, Map<String, String> customHeaderMap, Map<String, Object> paramMap, boolean forJson) {
        ...
        HttpPost httpPost = createPostBody(postUrl, customHeaderMap, paramMap, forJson);
        return executeEntity(httpPost);
    }
    ...
    public static String sendPut(String url, Map<String, String> customHeaderMap, Map<String, Object> paramMap, boolean forJson) {
        ...
        HttpPut httpPut = createPutBody(putUrl, customHeaderMap, paramMap, forJson);
    ...
    public static String sendDelete(String url, Map<String, String> customHeaderMap, Map<String, Object> paramMap, boolean forJson) {
        ...
        if (forJson) {
            HttpDeleteWithBody httpDeleteWithBody = createDeleteBody(deleteUrl, customHeaderMap, paramMap, forJson);
            return executeEntity(httpDeleteWithBody);
        }
        HttpDelete httpDelete = createDelete(deleteUrl, customHeaderMap);
    ...
    private static HttpDeleteWithBody createDeleteBody(String url, Map<String, String> headerMap, Map<String, Object> paramMap, boolean forJson) {
        HttpDeleteWithBody httpDelete = new HttpDeleteWithBody(url);
        setEntity(httpDelete, headerMap, paramMap, forJson);
        return httpDelete;
    }

    private static HttpPost createPostBody(String url, Map<String, String> headerMap, Map<String, Object> paramMap, boolean forJson) {
        HttpPost httpPost = new HttpPost(url);
        setEntity(httpPost, headerMap, paramMap, forJson);
        return httpPost;
    }

    private static HttpPut createPutBody(String url, Map<String, String> headerMap, Map<String, Object> paramMap, boolean forJson) {
        HttpPut httpPut = new HttpPut(url);
        setEntity(httpPut, headerMap, paramMap, forJson);
        return httpPut;
    }

    private static HttpGet createGet(String url, Map<String, String> headerMap) {
        HttpGet httpGet = new HttpGet(url.replaceAll(BLANK, URL_BLANK));
        setEntity(httpGet, headerMap);
        return httpGet;
    }

    private static HttpDelete createDelete(String url, Map<String, String> headerMap) {
        HttpDelete httpDelete = new HttpDelete(url.replaceAll(BLANK, URL_BLANK));
        setEntity(httpDelete, headerMap);
        return httpDelete;
    }

    // 设置请求参数

    private static void setEntity(HttpEntityEnclosingRequestBase http, Map<String, String> headerMap, Map<String, Object> paramMap, boolean forJson) {
        RequestConfig config = RequestConfig.custom().setSocketTimeout(DEFAULT_TIMEOUT).setConnectTimeout(DEFAULT_TIMEOUT).build();
    ...
    private static void setEntity(HttpRequestBase http, Map<String, String> headerMap) {
        RequestConfig config = RequestConfig.custom().setSocketTimeout(DEFAULT_TIMEOUT).setConnectTimeout(DEFAULT_TIMEOUT).build();
        http.setConfig(config);
        if (null != headerMap) {
            //添加自定义header
